...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	ProductFilterPage function init(){
		// Widget Properties
		setName( "Product Filter Page" );
		setVersion( "1.1" );
		setDescription( "A widget to display the product filter page elements." );
	...
	*/
	any function renderIt(){
		return renderView( view="widgets/productfilterpage-display", module="cbcommerce-ui" );
	}
}
