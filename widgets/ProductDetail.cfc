...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	ProductDetail function init(){
		// Widget Properties
		setName( "Product Detail Component" );
		setVersion( "1.1" );
		setDescription( "A widget to display product detail as a Vue component." );
	...
	*/
	any function renderIt(){
		return renderView( view="widgets/productdetail-display", module="cbcommerce-ui" );
	}
}
