...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	ShoppingCart function init(){
		// Widget Properties
		setName( "Shopping Cart Vue Component" );
		setVersion( "1.1" );
		setDescription( "A widget to display the shopping cart Vue component." );
	...
	*/
	any function renderIt(){
		return renderView( view="widgets/shoppingcart-display", module="cbcommerce-ui" );
	}
}
