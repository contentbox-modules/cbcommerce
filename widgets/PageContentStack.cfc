		...
		if( arguments.contentResults.count ){
			...
			for( var x=1; x lte arguments.max; x++ ){
				...
				if( textAlignment == "center" ){
					widgetContent &= renderView( view="widgets/page-content-stack/alignCenter", module="cbcommerce-ui", args=arguments );
				} else if( textAlignment == "right" ) {
					widgetContent &= renderView( view="widgets/page-content-stack/alignRight", module="cbcommerce-ui", args=arguments );
				} else {
					widgetContent &= renderView( view="widgets/page-content-stack/alignLeft", module="cbcommerce-ui", args=arguments );
				}
