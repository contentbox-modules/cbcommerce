...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	ProductComparison function init(){
		// Widget Properties
		setName( "Product Comparison Vue Component" );
		setVersion( "1.1" );
		setDescription( "A widget to display the product comparison Vue component." );
	...
	*/
	any function renderIt(){
		// generate
		return renderView( view="widgets/productcomparison-display", module="cbcommerce-ui" );
	}
}
