...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	BestSellerCarousel function init(){
		// Widget Properties
		setName( "Best Selling Products Carousel" );
		setVersion( "1.1" );
		setDescription( "A widget to display best selling products as a Vue carousel." );
	...
	*/
	any function renderIt(){
		return renderView( view="widgets/bestsellercarousel-display", module="cbcommerce-ui" );
	}
}
